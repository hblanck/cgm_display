...
def display_reading(reading, bgdelta):
    ...
    try:
        ...
        rect = text_surface.get_rect(center=(70,30))
        lcd.blit(text_surface, rect)
        rect = text_surface.get_rect(center=(70,160+30))
        lcd.blit(text_surface, rect)
        ...
        rect = text_surface.get_rect(center=(100,30))
        lcd.blit(text_surface, rect)
        rect = text_surface.get_rect(center=(100,160+30))
        lcd.blit(text_surface, rect)
        
        font_medium = pygame.font.Font(None, 67)
        text_surface = font_medium.render('{0:{1}}'.format(bgdelta, '+' if bgdelta else ''),True,font_color)
        rect = text_surface.get_rect(center=(320, 30))
        lcd.blit(text_surface, rect)
        rect = text_surface.get_rect(center=(320, 160+30))
        lcd.blit(text_surface, rect)
